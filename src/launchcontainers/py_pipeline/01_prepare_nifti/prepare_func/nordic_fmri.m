function nordic_fmri(src_dir, output_dir, sub, ses, nordic_scans_end, doNORDIC, dotsnr, force)
    ...
    output_dir = fullfile('/bcbl/home/public/Gari/VOTCLOC/main_exp','BIDS_mag');
    ...
    dotsnr = false;
    %to run it
    code_dir='/bcbl/home/home_n-z/tlei/soft/MRIworkflow/01_prepare_nifti/prepare_func/'; 
    subses=importdata(fullfile(code_dir,'subses_List.txt'));

...
def glm_l1(
    bids, input_bids, subject, session, fp_ana_name,
    output_name, slice_time_ref=0.5, use_smoothed=False, sm=None,
):
...
def main():
    ...
    glm_l1(
        bids_dir, input_bids, subject, session, fp_ana_name,
        output_name, slice_time_ref, use_smoothed, sm,
    )
    return

...
for contrast in ${contrasts}; do
	...
	pmap_dir=/bcbl/home/public/Gari/VOTCLOC/VSS/derivatives/vertexwise_count/3_cluster/sub-${sub}

	pmap_fname=$pmap_dir/sub-${sub}_${contrast}_fsnative_sm${sm}.gii
	pmap_fname_fsaverage=$pmap_dir/sub-${sub}_${contrast}_fsaverage_sm${sm}.gii

...
#%%
    ...
    #  get overlay file
    sulc_left=  fs.read_morph_data('/bcbl/home/public/Gari/MINI/ANALYSIS/freesurferacpc/fsaverage/surf/lh.sulc')

    # load ROI to plot as contours
    motspots=fs.read_annot('/bcbl/home/public/Gari/MINI/ANALYSIS/freesurferacpc/fsaverage/label/lh.motspots.annot')
    # get the label
...
#                        darkness=.5, engine='matplotlib')
    ...
    figure_v= plotting.plot_surf_roi(fsaverage, roi_map=clusters,
